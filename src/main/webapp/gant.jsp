...
<head>
  ...
  <link rel=stylesheet href="${pageContext.request.contextPath}/jqueryGant/platform.css" type="text/css">
  <link rel=stylesheet href="${pageContext.request.contextPath}/jqueryGant/libs/jquery/dateField/jquery.dateField.css" type="text/css">

  <link rel=stylesheet href="${pageContext.request.contextPath}/jqueryGant/gantt.css" type="text/css">
  <link rel=stylesheet href="${pageContext.request.contextPath}/jqueryGant/ganttPrint.css" type="text/css" media="print">

  <script src="${pageContext.request.contextPath}/jqueryGant/libs/jquery/3.3.1/jquery.min.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>

  <script src="${pageContext.request.contextPath}/jqueryGant/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/jquery/jquery.timers.js"></script>

  <script src="${pageContext.request.contextPath}/jqueryGant/libs/utilities.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/forms.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/date.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/dialogs.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/layout.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/i18nJs.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/jquery/dateField/jquery.dateField.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/libs/jquery/JST/jquery.JST.js"></script>

  <script type="text/javascript" src="${pageContext.request.contextPath}/jqueryGant/libs/jquery/svg/jquery.svg.min.js"></script>
  <script type="text/javascript" src="${pageContext.request.contextPath}/jqueryGant/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


  <script src="${pageContext.request.contextPath}/jqueryGant/ganttUtilities.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/ganttTask.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/ganttDrawerSVG.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/ganttZoom.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/ganttGridEditor.js"></script>
  <script src="${pageContext.request.contextPath}/jqueryGant/ganttMaster.js"></script>  
